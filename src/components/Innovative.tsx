...
const Innovative = () => {
  return (
    <div className="relative flex flex-col lg:flex-row items-center justify-center gap-[150px] px-[30px] lg:px-[100px]">
      <div className="flex flex-col gap-[30px] pt-[219px] pb-[236px] w-full lg:w-[575px]">
      ...
      <div className="max-w-[97px] w-full absolute -bottom-[40px] right-[100px] 2xl:right-[300px] z-10">

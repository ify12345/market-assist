...
const SecondaryButton: React.FC<ButtonProps> = ({ children, onClick, className, loading }) => {
  const defaultStyles = 'flex justify-center items-center w-[120px] h-[42px] rounded-[30px] bg-transparent text-primary border border-primary font-[500] text-[16px] leading-[16px] hover:scale-95 transition-all duration-300';
